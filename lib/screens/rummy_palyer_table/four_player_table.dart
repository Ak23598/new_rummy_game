...
class FourPlayerTableWidget extends StatefulWidget {
  final List<bool> servedPages;
  final List<bool> flipedPages;
  final List<int> cardPage;

  const FourPlayerTableWidget({super.key,
  ...
  @override
  State<FourPlayerTableWidget> createState() => _FourPlayerTableWidgetState();
}

class _FourPlayerTableWidgetState extends State<FourPlayerTableWidget> {
